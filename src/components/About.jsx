...
const About = () => {
  return (
    <section className="p-6 mt-20 bg-gray-100">
      <h2 className="text-4xl font-bold mb-8 ml-[395px] text-gray-800">About Me</h2>
      
      <div className="flex flex-col md:flex-row items-start">
        <div className="md:w-1/3 mb-6 md:mb-0 self-start">
          <img 
            ...
            alt="Profile" 
            className="rounded-full shadow-lg transform hover:scale-105 h-[200px] w-[200px] transition-transform duration-300"
          />
        </div>
        ...
        <div className="md:w-2/3 md:pl-6">
          ...
          <h3 className="text-3xl font-semibold text-gray-800 mb-4">Background</h3>
          ...
          <h3 className="text-3xl font-semibold text-gray-800 mt-8 mb-4">Interests</h3>
